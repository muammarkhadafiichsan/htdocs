                ...
                <ul class="dropdown-menu">
					...
					<li class="user-footer">
						...
						<div class="pull-right">
							<a class="btn btn-default btn-flat" href="<?php echo site_url('auth/logout') ?>" onclick="return confirm('<?php echo lang('menu_nav_logout_confirmation_message') ?>')"><i class="fa fa-sign-out fa-fw"></i> <?php echo lang('auth_sign_out') ?></a>
						</div>
					</li>
                </ul>
            </li>
