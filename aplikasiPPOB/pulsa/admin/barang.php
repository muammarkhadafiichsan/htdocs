...
<h3><span class="glyphicon glyphicon-briefcase"></span>  Data Operator</h3>
<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambah Barang</button>
<br/>
<br/>

<?php 
$periksa=mysqli_query($link,"select * from barang where jumlah <=3");
...
<?php 
$per_hal=100;
$jumlah_record=mysqli_query($link,"SELECT COUNT(*) from barang");
$jum=mysqli_free_result($jumlah_record);
...
<table class="table table-hover">
	<tr>
		...
		<th class="col-md-4">Nama Operator</th>
	...
	if(isset($_GET['cari'])){
		...
		$brg=mysqli_query($link,"select * from barang where nama like '$cari' or jenis like '$cari'");
	}else{
		$brg=mysqli_query($link,"select * from barang limit $start, $per_hal");
	}
	$no=1;
	...
	<tr>
		...
		<?php 
			...
			$x=mysqli_query($link,"select sum(modal) as total from barang");	
			...
			<div class="modal-body">
				<form action="tmb_brg_act.php" method="post">
					<div class="form-group">
						...
						<input name="nama" type="text" class="form-control" placeholder="Nama Operator ..">
					</div>
					<div class="form-group">
						<label>Jenis</label>
