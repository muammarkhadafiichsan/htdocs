...
$query=mysqli_query($link,"select * from barang_laku where tanggal=" . $tanggal);
...
$q=mysqli_query($link,"select sum(total_harga) as total from barang_laku where tanggal=".$tanggal);
...
$qu=mysqli_query($link,"select sum(laba) as total_laba from barang_laku where tanggal=".$tanggal);
// select sum(total_harga) as total from barang_laku where tanggal='$tanggal'
