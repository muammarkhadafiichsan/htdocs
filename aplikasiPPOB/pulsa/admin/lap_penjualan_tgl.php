...
$query=mysqli_query($link,"select * from barang_laku where tanggal>='$dari' and tanggal<='$sampai' order by tanggal asc");
...
$q=mysqli_query($link,"select sum(total_harga) as total from barang_laku where tanggal>='$dari' and tanggal<='$sampai' order by tanggal asc");
...
$qu=mysqli_query($link,"select sum(laba) as total_laba from barang_laku where tanggal>='$dari' and tanggal<='$sampai' order by tanggal asc");
