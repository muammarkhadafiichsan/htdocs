...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputData("BIBIT KAMBING BOER FULLBLOOD","artikel_1.html");
        inputData("JUAL BIBIT KAMBING KACANG JANTAN","artikel_2.html");
        inputData("JUAL AMPAS (ONGGOK) JAGUNG","artikel_3.html");
        inputData("TERNAK AYAM PETELUR","artikel_4.html");
