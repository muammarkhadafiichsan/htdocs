package com.pbob.aplikasi.tugasbesar;
...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tabAdapter.addFragment(new galeri(), "Tab 3");
		tabAdapter.addFragment(new notif(), "Tab 4");
		tabAdapter.addFragment(new AkunFragment(), "Tab 5");
