...
<head>
	...
	<title>DINAS PETERNAKAN KABUPATEN BONDOWOSO</title>
...
<body>
	<div class="jumbotron text-center" id="headerApps">
        <div>
            <img src="<?= base_url('assets/images/bws.png') ?>">
        </div>
        <div>
	        <h1> <strong>SIDINAK</strong> </h1>
	        <h4>Sistem Informasi Dinas Peternakan</h4>
			<h4>Kabupaten Bondowoso</h4>
	    </div>
	</div>
      ...
      <div class="container">
            <ul class="nav nav-pills nav-justified" id="subNavHeader">
							<?php if($this->uri->segment(1) === 'jenis-anggota'): ?>
								<li role="presentation" class="active"><a href="<?= base_url('jenis-anggota') ?>"> <span class="fa fa-user fa-lg"></span> null</a></li>
							<?php else: ?>
								<li role="presentation"><a href="<?= base_url('jenis-anggota') ?>"> <span class="fa fa-user fa-lg"></span> null</a></li>
							<?php endif ?>
							<?php if($this->uri->segment(1) === 'jenis-perjalanan'): ?>
								<li role="presentation" class="active"><a href="<?= base_url('jenis-perjalanan') ?>"><span class="fa fa-map-o fa-lg"></span> null</a></li>
							<?php else: ?>
								<li role="presentation"><a href="<?= base_url('jenis-perjalanan') ?>"><span class="fa fa-map-o fa-lg"></span> null</a></li>
							<?php endif ?>
							<?php if($this->uri->segment(1) === 'jenis-kegiatan'): ?>
								<li role="presentation" class="active"><a href="<?= base_url('jenis-kegiatan') ?>"><span class="fa fa-podcast fa-lg"></span> null</a></li>
							<?php else: ?>
								<li role="presentation"><a href="<?= base_url('jenis-kegiatan') ?>"><span class="fa fa-podcast fa-lg"></span> null</a></li>
							<?php endif ?>
	...
	<?php if($this->uri->segment(1) === 'kegiatan' || $this->uri->segment(1) === 'panjar' || $this->uri->segment(1) === 'pelunasan' || $this->uri->segment(1) === 'transaksi'): ?>
            ...
            <ul class="nav nav-pills nav-justified" id="subNavHeader">
							...
							<?php if($this->uri->segment(1) === 'panjar'): ?>
								<li role="presentation" class="active"><a href="<?= base_url('panjar') ?>"><span class="fa fa-money fa-lg"></span> null</a></li>
							<?php else: ?>
								<li role="presentation"><a href="<?= base_url('panjar') ?>"><span class="fa fa-money fa-lg"></span> null</a></li>
							<?php endif ?>
							<?php if($this->uri->segment(1) === 'pelunasan'): ?>
								<li role="presentation" class="active"><a href="<?= base_url('pelunasan') ?>"><span class="fa fa-check fa-lg"></span> null</a></li>
							<?php else: ?>
								<li role="presentation"><a href="<?= base_url('pelunasan') ?>"><span class="fa fa-check fa-lg"></span> null</a></li>
							<?php endif ?>
            </ul>
      </div>
	<?php endif ?>
