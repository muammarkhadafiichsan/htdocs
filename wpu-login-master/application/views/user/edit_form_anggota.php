            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        ...
                        <a href="<?php echo site_url('admin/anggota_puskeswan/') ?>"><i class="fas fa-arrow-left"></i>
                            Back</a>
                    </div>
                    <div class="card-body">

                        <form action="<?php base_url('admin/anggota_puskeswan/edit') ?>" method="post" enctype="multipart/form-data">

                            <input type="hidden" name="id" value="<?php echo $anggota_puskeswan->id_puskeswan ?>" />

                            <div class="form-group">
                                <label for="name">Nama_kepala*</label>
                                <input class="form-control <?php echo form_error('nama_kepala') ? 'is-invalid' : '' ?>" type="text" name="name" placeholder="Nama kepala" value="<?php echo $product->name ?>" />
