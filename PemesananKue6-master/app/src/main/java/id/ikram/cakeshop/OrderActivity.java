...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListMenu.add("Chocolate Cake");
        mListMenu.add("Strawberry Cake");
        mListMenu.add("Black forest");
        mListMenu.add("Hazelnut Cake");
        mListMenu.add("Cheese Cake");//memasukan info ke spinner
    ...
    public void onClickOrder(View view) { //hanya memilih salah satu radiobox dan mendapatkan text untuk item
        ...
        String to = "ikramyunizar@gmail.com";
